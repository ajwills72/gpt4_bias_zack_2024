...
def generate_prompts(condition: str, demographics: bool) -> list[list[str]]:
    """Generate a ton of prompts. If demographics is true, explicitly ask the model to include demographic information."""
    all_prompts = []
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--condition', type=str, default='Sarcoidosis')
    argparser.add_argument('--demographics', default=True, action='store_true')
